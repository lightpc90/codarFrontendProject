    ...
    return (
        <div className='flex flex-col lg:flex-row gap-4 justify-between w-full'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                {/* --------- */}
                <div className='flex flex-wrap items-center mb-6 gap-2 h-[50px]'>
                    <QuantityButton quantity={quantity} setQuantity={setQuantity} />
                    <button className='bg-primary px-6 py-2 h-[50px] text-sm 2xl:text-md font-bold text-white'>ADD TO CART</button>
